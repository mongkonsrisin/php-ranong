...
'รักท่องเที่ยว รักธรรมชาติ รักระนอง' ระนอง เป็นจังหวัดชายฝั่งทะเลด้านตะวันตกในภาคใต้ของประเทศไทย มีพื้นที่ประมาณ 2 ล้านไร่ ทิศตะวันตกติดกับทะเลอันดามันและประเทศเมียนมาร์ซึ่งครอบคลุมไปถึงทิศเหนือ ทิศตะวันออกติดกับจังหวัดชุมพร ส่วนทิศใต้ติดกับจังหวัดพังงาและสุราษฏร์ธานี แหล่งท่องเที่ยวที่นิยมในระนองจะมีน้ำตกและบ่อน้ำร้อนหลายแห่ง ให้นักท่องเที่ยวได้มาอาบน้ำแร่ธรรมชาติได้ตามอัธยาศัย">
    ...
    <link rel="stylesheet" href="assets/css/package02.css">
 ...
 <?php require_once('./navbar.php')?>
  <!-- end nav -->
    ...
    <div class="backgroundpackgate ">
            ...
            <div class="test">
            <div class="detail-event" style="margin-top:30px;">
            <div class="row">
                    <div class="col-md-12">
                    <div class="detail-packgate-mobile">
                        <p style="font-size: 2em;text-align: center    ;background-color:rgba(169, 199, 157, 0.7411764705882353);"> รายการท่องเที่ยว </p>
                            ...
                            <?php 
                                $i = 1;
                                $sql = "SELECT * FROM tbl_package WHERE pk_id=2";
                        ...
                        <div class="packgate-left-mobile">
                            <div class="single-item imgslide">
                                <div class="img_layout">
                                    <img src="assets/img/package/2/slide/1-1.png" alt="">
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/2/slide/1-2.png" alt="">
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/2/slide/1-3.png" alt="">
                                </div>
                            </div>
                            <h1> <img src="assets/img/package/2/05.png" class="num"> <?=$poiName[6]?></h1>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="packgate-right-mobile">
                            <div class="single-item imgslide">
                                <div class="img_layout">
                                    <img src="assets/img/package/2/slide/2-1.png" alt="">
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/2/slide/2-2.png" alt="">
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/2/slide/2-3.png" alt="">
                                </div>
                            </div>
                            <h1><img src="assets/img/package/2/06.png" alt="" class="num"> <?=$poiName[7]?></h1>
                            <p style="font-size:2em;">กิจกรรม: <?=$actdetail['detail'][7]?></p>
                            <p style="font-size:2em;">เวลา: <?=$actdetail['time'][7]?> นาที</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="road-mobile" >
                            <img src="assets/img/package/2/t_roadpackget2_02.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="packgate-right2-mobile">
                            <div class="single-item imgslide">
                                <div class="img_layout">
                                    <img src="assets/img/package/2/slide/3-1.png" alt="">
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/2/slide/3-2.png" alt="">
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/2/slide/3-3.png" alt="">
                                </div>
                            </div>
                            <h1><img src="assets/img/package/2/17.png" alt="" class="num"> <?=$poiName[18]?></h1>
                            <p style="font-size:1em;">กิจกรรม: <?=$actdetail['detail'][18]?></p>
                            <p style="font-size:1em;">เวลา: <?=$actdetail['time'][18]?> นาที</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="packgate2">
        <div class="backgroundpackgate2 d-none d-lg-block">
            <div class="detail-event">
                <div class="row">
                    <div class="col-md-6">
                    <div class="detail-packgate"> 
                        ...
                        <div class="packgate-right2">
                            ...
                            <h2> <img src="assets/img/package/2/17.png" alt="" class="num"> <?=$poiName[18]?></h2>
                            <p style="font-size:1em;">กิจกรรม: <?=$actdetail['detail'][18]?></p>
                            <p style="font-size:1em;">เวลา: <?=$actdetail['time'][18]?> นาที</p>
                        </div>
                    </div>
