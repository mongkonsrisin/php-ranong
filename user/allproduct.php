...
&nbsp;&nbsp;
  ...
  <table class="table table-hover table-responsive-sm">
    ...
    <tbody>
      <?php
        $sql = "SELECT * FROM tbl_product pro LEFT JOIN tbl_poi poi ON (pro.pro_poiid = poi.poi_id) WHERE pro.pro_poiid=".$_SESSION['id'];
        if(isset($_GET['q'])) {
          $sql = "SELECT * FROM tbl_product pro LEFT JOIN tbl_poi poi ON (pro.pro_poiid = poi.poi_id) WHERE (pro_name LIKE '%$q%' OR pro_description LIKE '%$q%' OR pro_price LIKE '%$q%') AND pro.pro_poiid=".$_SESSION['id'];
        }
