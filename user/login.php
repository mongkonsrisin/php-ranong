...
if($_SERVER['REQUEST_METHOD']=='POST') {
  ...
  $sql = "SELECT * FROM tbl_poi WHERE poi_username = ? AND poi_password = ?";
  ...
  if($result->num_rows > 0) {
    ...
    $_SESSION['user'] = $row['poi_username'];
    $_SESSION['cat'] = $row['poi_cat'];
    $_SESSION['id'] = $row['poi_id'];
...
<form class="form-signin text-center" action="" method="post">
      ...
      <br>
      <h3 class="mb-3"><b>ผู้ใช้งาน</b></h3>
