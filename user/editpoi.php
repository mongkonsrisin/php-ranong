...
<div class="container">
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        empty($poi_lat) || empty($poi_lng) || empty($poi_subdistrict) || empty($poi_district) || empty($poi_zipcode)) {
          //Empty fields.
          //Empty fields.
          ...
          //Okay.
        $sql_update = "UPDATE tbl_poi  SET poi_name=?,poi_description=?,poi_housenumber=?,poi_moo=?,poi_alley=?,poi_street=?,
            poi_subdistrict=?,poi_district=?,poi_province=?,poi_zipcode=?,poi_phone=?,poi_mobile=?,poi_website=?,
            poi_email=?,poi_facebook=?,poi_line=? WHERE poi_id=?";
              ...
              $poi_name,$poi_description,
              $poi_housenumber,$poi_moo,$poi_alley,
              $poi_street,$poi_subdistrict, $poi_district,$poi_province,$poi_zipcode,$poi_phone,
              $poi_mobile,$poi_website,$poi_email,$poi_facebook,$poi_line,$id);
              $stmt_update->execute();
