...
<body>
    ...
    <div class="container" style="margin-top:100px">
        ...
        <div class="col-sm-4 head d-none d-lg-block" align="center" style="padding-right:0;padding-left:0px;background-color:transparent;background-size:cover;color:#fff;">
            ...
            <div class="col-sm-4 headtext d-none d-lg-block" align="center" style="background:transparent;color:#FDD835;">
            ...
            <div class="col-sm-4 lamp2  d-none d-lg-block" style="padding-right:0;padding-left:0;">
        ...
        <div class="row hidden-xs-up back2">
            <div class="col-lg-6 d-lg-none headtext" align="center" style="padding-right:0;padding-left:0px;background-image: transparent;background-size:cover;color:#fff;">
            ...
            <div class="col-lg-6 headtext d-lg-none" align="center" style="padding-right:0;padding-left:0;background-color:transparent;">
    ...
    <div class="container" align="right">
        <p>
            <button class="btn btn-block btn-5 btn-5a icon-cart" onclick="window.location.href='gallery.php?id=<?=$_GET['id']?>&back=healthy'"><a>Gallery</a></button>
        </p>
    </div>
