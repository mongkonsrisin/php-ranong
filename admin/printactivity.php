...
$this->Cell(0,10,'รายการกิจกรรม',0,0,'L');
$this->Cell(0,10,$result->num_rows,0,0,'C');
// Line break
$this->Ln(25);  //preprint
$this->Cell(10,10,'#',1,0,'C');
$this->Cell(50,10,'รูปกิจกรรม',1,0,'C');
$this->Cell(130,10,'รายละเอียดกิจกรรม',1,1,'C');
}
// Page footer
function Footer()
{
...
$pdf->Cell(10,50,$row['act_id'],1,0,'C');
...
$y2=$pdf->GetY();
$pdf->SetXY($x,$y);
$pdf->Cell(110,10,$row['act_name'],0,1,'L');
$pdf->SetFont('Angsana','',16);
$pdf->SetX($x);
$pdf->Cell(110,8,'ระยะเวลา: '.$row['act_time'].' นาที',0,1,'L');
$pdf->SetX($x);
$pdf->MultiCell(110,8,'ประเภท: '.$row['act_detail'],0,'L',false);
$act_icon = $row['act_icon'];
$pic = '../assets/img/package/icon/'.$act_icon.'.png';
if (file_exists($pic)) {
