...
$this->Cell(0,10,'รายการหมุดสถานที่',0,0,'L');
$this->Cell(0,10,$result->num_rows,0,0,'C');
// Line break
$this->Ln(25);  //preprint
$this->Cell(10,10,'#',1,0,'C');
$this->Cell(30,10,'รูปหมุด',1,0,'C');
$this->Cell(150,10,'ชื่อ',1,1,'C');
}
// Page footer
function Footer()
{
...
$pdf->Cell(10,20,$row['pin_id'],1,0,'C');
$pdf->Cell(30,20,'',1,0,'L');
$x=$pdf->GetX();
$ximg=$x-28;
$y=$pdf->GetY();
$pdf->Cell(150,20,'',1,1,'L');
$x2=$pdf->GetX();
$y2=$pdf->GetY();
$pdf->SetXY($x,$y);
$pdf->Cell(110,10,$row['pin_name'],0,1,'L');
$pin_id = $row['pin_id'];
$pic = '../assets/img/pin/pin'.$pin_id.'.png';
if (file_exists($pic)) {
$pdf->Image($pic,$ximg,$y+1,20);
} else {
$pdf->Image('assets/img/no_image.png',$ximg,$y+1,20);
}
}
$pdf->SetXY($x2,$y2);
$user = $_SESSION['user'];
