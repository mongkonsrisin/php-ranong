...
'รักท่องเที่ยว รักธรรมชาติ รักระนอง' ระนอง เป็นจังหวัดชายฝั่งทะเลด้านตะวันตกในภาคใต้ของประเทศไทย มีพื้นที่ประมาณ 2 ล้านไร่ ทิศตะวันตกติดกับทะเลอันดามันและประเทศเมียนมาร์ซึ่งครอบคลุมไปถึงทิศเหนือ ทิศตะวันออกติดกับจังหวัดชุมพร ส่วนทิศใต้ติดกับจังหวัดพังงาและสุราษฏร์ธานี แหล่งท่องเที่ยวที่นิยมในระนองจะมีน้ำตกและบ่อน้ำร้อนหลายแห่ง ให้นักท่องเที่ยวได้มาอาบน้ำแร่ธรรมชาติได้ตามอัธยาศัย">
    ...
    <link rel="stylesheet" href="assets/css/package07.css">
    <link rel="stylesheet" href="assets/css/responsive07.css">
...
<div class="backgroundpackgate" style="margin-top:40px;">
            <div class="detail-event">
                <div class="row"> 
                <div class="col-md-12">
                        <div class="detail-packgate7" style="font-size:1em;"> 
                        <p style="font-size:1em;text-align:center ; background-color: rgba(169, 199, 157, 0.7411764705882353);"> รายการท่องเที่ยว </p>
                        
                        <?php 
                                $i = 1;
                                $sql = "SELECT * FROM tbl_package WHERE pk_id=7";
                ...
                <div class="col-md-12">
                        ...
                        <img src="assets/img/package/7/day12.png" alt="">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="packgate-right-mobile">
                            <div class="single-item imgslide">
                                <div class="img_layout">
                                    <img src="assets/img/package/7/slide/2-1.png" alt="">
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/7/slide/2-2.png" alt="">
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/7/slide/2-3.png" alt="">
                                </div>
                            </div>
                            <h1><img src="assets/img/package/7/03.png" alt="" class="num"> <?=$poiName[4]?></h1>
                            <p style="font-size:1em;">กิจกรรม: <?=$actdetail['detail'][4]?></p>
                            <p style="font-size:1em;">เวลา: <?=$actdetail['time'][4]?> นาที</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">             
                    <div class="col-md-12">
                        <div class="packgate-right-mobile">
                            <div class="single-item imgslide">
                                <div class="img_layout">
                                    <img src="assets/img/package/7/slide/1-1.png" alt="">
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/7/slide/1-2.png" alt="">
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/7/slide/1-3.png" alt="">
                                </div>
                            </div>
                            <h1><img src="assets/img/package/7/08.png" alt="" class="num"> <?=$poiName[9]?></h1>
                            <p style="font-size:1em;">กิจกรรม: <?=$actdetail['detail'][9]?></p>
                            <p style="font-size:1em;">เวลา: <?=$actdetail['time'][9]?> นาที</p>
                        </div>
                    </div>
                </div>
            </div>
     ...
     <div class="packgate">
        <div class="backgroundpackgatep" style="margin-top:90px;">
        <div class="road">
                        <img src="assets/img/package/7/day12.png" alt="">
                        </div>
            <div class="detail-event">
                ...
                <div class="col-6">
                        ...
                        <div class="detail-packgate7" style="font-size:21px;">
                    ...
                    <div class="col-3">
                        <div class="packgate-right2">
                            ...
                            <h2><img src="assets/img/package/7/08.png" alt="" class="num"> <?=$poiName[9]?></h2>
                            <p style="font-size:1em;">กิจกรรม: <?=$actdetail['detail'][9]?></p>
                            <p style="font-size:1em;">เวลา: <?=$actdetail['time'][9]?> นาที</p>
                        </div>
                    </div>
                     ...
                     <div class="col-6">
                        <div class="packgate-right">
                            ...
                            <h2><img src="assets/img/package/7/03.png" alt="" class="num"> <?=$poiName[4]?></h2>
                            <p style="font-size:1em;">กิจกรรม: <?=$actdetail['detail'][4]?></p>
                            <p style="font-size:1em;">เวลา: <?=$actdetail['time'][4]?> นาที</p>
                        </div>
                    </div>
