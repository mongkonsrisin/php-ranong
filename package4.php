...
'รักท่องเที่ยว รักธรรมชาติ รักระนอง' ระนอง เป็นจังหวัดชายฝั่งทะเลด้านตะวันตกในภาคใต้ของประเทศไทย มีพื้นที่ประมาณ 2 ล้านไร่ ทิศตะวันตกติดกับทะเลอันดามันและประเทศเมียนมาร์ซึ่งครอบคลุมไปถึงทิศเหนือ ทิศตะวันออกติดกับจังหวัดชุมพร ส่วนทิศใต้ติดกับจังหวัดพังงาและสุราษฏร์ธานี แหล่งท่องเที่ยวที่นิยมในระนองจะมีน้ำตกและบ่อน้ำร้อนหลายแห่ง ให้นักท่องเที่ยวได้มาอาบน้ำแร่ธรรมชาติได้ตามอัธยาศัย">
    ...
    <link rel="stylesheet" href="assets/css/package04.css">
    <link rel="stylesheet" href="assets/css/pack4_responsive.css">
            ...
            <div class="detail-event">
                ...
                <div class="col-md-12">
                        <div class="road-mobile">  
                            <img src="assets/img/package/4/package4.png" alt="">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="packgate-right" >
                            <div class="single-item imgslide" >
                                <div class="img_layout">
                                    <img src="assets/img/package/4/slide/1-1.png" alt="" >
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/4/slide/1-2.png" alt="" >
                                </div>
                                <div class="img_layout">
                                    <img src="assets/img/package/4/slide/1-3.png" alt="" >
                                </div>
                            </div>
                            <h1><img src="assets/img/package/4/03.png" alt="" class="num"> <?=$poiName[4]?></h1>
                            <p style="font-size: 1em;">กิจกรรม: <?=$actdetail['detail'][4]?></p>
                            <p style="font-size: 0.9em;">เวลา: <?=$actdetail['time'][4]?> นาที</p> 
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="packgate">
        ...
        <div class="road">
            ...
            <div class="detail-event">
                ...
                <div class="col-md-6">
                    <div class="detail-packgate4"> 
                        <p style="font-size: 2.5em;text-align: center; background-color: rgba(169, 199, 157, 0.7411764705882353);"> รายการท่องเที่ยว </p>
                            <p style="font-size: 1.8em;">
                            <?php 
                                $i = 1;
                                $sql = "SELECT * FROM tbl_package WHERE pk_id=4";
                ...
                <div class="col-lg-8"></div>
                    <div class="col-lg-4">
                        <div class="packgate-right" style="right:160;margin:0">
                            <div class="single-item imgslide">
                                <div class="img_layout">
                                    <img src="assets/img/package/4/slide/1-1.png" alt="">
                                </div>
